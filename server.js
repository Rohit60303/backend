...
// --- FINAL FIX: USING WILDCARD ORIGIN ('*') ---
// This is necessary because Vercel uses dynamic URLs (like cowrite-9q6bms6l4-...)
// and hardcoding a single URL leads to persistent CORS rejection.

// Enhanced Socket.IO configuration
const io = socketIo(server, {
  cors: {
    // FIX 1: Allow ALL origins for Socket.IO
    origin: "*", 
    methods: ["GET", "POST"]
  },
  pingInterval: 5000,
...
app.use(cors({
  // FIX 2: Allow ALL origins for Express HTTP routes
  origin: "*",
